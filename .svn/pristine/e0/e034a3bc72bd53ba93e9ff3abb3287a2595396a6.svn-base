...
/**
 * 食堂入库单明细视图
 * @author 刘斌 2017年7月26日15:54:38
 *
 */
@Entity
@Table(name = "ViewInStockItem")
public class ViewInStockItem implements Serializable {
	...
	public ViewInStockItem() {
		super();
	}
	
	public ViewInStockItem(int uid,String productName,String unit,double instockprice,double instockquantity,double instockmoney) {
		super();
		this.uid=uid;
		this.productName=productName;
		this.unit=unit;
